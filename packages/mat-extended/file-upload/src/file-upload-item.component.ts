      ...
      @if (sortable()) {
        <div class="flex items-center gap-0.5 shrink-0">
          <div class="flex flex-col gap-px">
            <button type="button" class="flex items-center justify-center w-4 h-4 border-none bg-transparent text-[var(--mat-sys-on-surface-variant)] cursor-pointer rounded-sm transition-colors duration-150 hover:bg-[var(--mat-sys-surface-variant)] hover:text-[var(--mat-sys-on-surface)]" (click)="onMoveUp()" aria-label="Move up">
            ...
            <button type="button" class="flex items-center justify-center w-4 h-4 border-none bg-transparent text-[var(--mat-sys-on-surface-variant)] cursor-pointer rounded-sm transition-colors duration-150 hover:bg-[var(--mat-sys-surface-variant)] hover:text-[var(--mat-sys-on-surface)]" (click)="onMoveDown()" aria-label="Move down">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
          </div>
          <div class="flex items-center text-[var(--mat-sys-on-surface-variant)] cursor-grab active:cursor-grabbing" cdkDragHandle>
