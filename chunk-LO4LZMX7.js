...
onConfirmRename(item: RuiFileItem): void {
  ...
  this.editValue.set('');
}`;managementHtml=`<rui-file-upload-item
  [item]="item"
  [fileManagement]="true"
  (remove)="removeItem(item.id)"
  (retry)="retryItem(item)"
  (cancelUpload)="cancelItem(item.id)"
/>`;managementTs=`retryItem(item: RuiFileItem): void {
  this.items.update(items =>
...
}`;static \u0275fac=function(e){return new(e||u)};static \u0275cmp=w({type:u,selectors:[["rui-file-upload-item-demo"]],decls:55,vars:18,consts:[[1,"max-w-4xl","mx-auto","space-y-8","p-4"],[1,"font-bold"],[1,"flex","flex-col","gap-2"],[3,"item"],[3,"retry","item"],[3,"html","ts"],["id","sortable"],["cdkDropList","",1,"flex","flex-col","gap-2",3,"cdkDropListDropped"],[3,"item","sortable","dragStartDelay","fileManagement"],["id","editable"],[1,"mb-3",3,"change","checked"],[3,"item","editable","editableExtension","fileManagement","editingItemId","editInputValue"],["id","file-management"],[1,"flex","items-center","gap-4","mb-4"],[3,"change","checked"],["cdkDropList","",1,"flex","flex-col","gap-2",3,"cdkDropListDropped","cdkDropListDisabled"],[3,"item","sortable","dragStartDelay","editable","fileManagement","editingItemId","editInputValue"],[3,"remove","moveUp","moveDown","item","sortable","dragStartDelay","fileManagement"],[3,"startRename","confirmRename","cancelRename","editInputChange","remove","item","editable","editableExtension","fileManagement","editingItemId","editInputValue"],[3,"remove","retry","cancelUpload","startRename","confirmRename","cancelRename","editInputChange","moveUp","moveDown","item","sortable","dragStartDelay","editable","fileManagement","editingItemId","editInputValue"]],template:function(e,t){e&1&&(r(0,"div",0)(1,"h1",1),c(2,"File Management"),m(),r(3,"mat-card")(4,"mat-card-header")(5,"mat-card-title"),c(6,"Standalone Item States"),m()(),r(7,"mat-card-content",2),v(8,"rui-file-upload-item",3)(9,"rui-file-upload-item",3)(10,"rui-file-upload-item",3),r(11,"rui-file-upload-item",4),g("retry",function(){return t.onRetry(t.errorItem)}),m()()(),v(12,"rui-showcase-code",5),r(13,"h2",6),c(14,"Sortable Items"),m(),r(15,"mat-card")(16,"mat-card-header")(17,"mat-card-title"),c(18,"Drag & Drop Reorder"),m()(),r(19,"mat-card-content")(20,"div",7),g("cdkDropListDropped",function(n){return t.onDrop(n)}),h(21,H,1,4,"rui-file-upload-item",8,y),m()()(),v(23,"rui-showcase-code",5),r(24,"h2",9),c(25,"Editable Items (Rename)"),m(),r(26,"mat-card")(27,"mat-card-header")(28,"mat-card-title"),c(29,"Inline Rename"),m()(),r(30,"mat-card-content")(31,"mat-slide-toggle",10),g("change",function(n){return t.allowExtEdit.set(n.checked)}),c(32),m(),r(33,"div",2),h(34,j,1,6,"rui-file-upload-item",11,y),m()()(),v(36,"rui-showcase-code",5),r(37,"h2",12),c(38,"File Management (Retry, Cancel, Remove)"),m(),r(39,"mat-card")(40,"mat-card-header")(41,"mat-card-title"),c(42,"Full File Management"),m()(),r(43,"mat-card-content")(44,"div",13)(45,"mat-slide-toggle",14),g("change",function(n){return t.showFileMgmt.set(n.checked)}),c(46," File Management "),m(),r(47,"mat-slide-toggle",14),g("change",function(n){return t.showEditable.set(n.checked)}),c(48," Editable "),m(),r(49,"mat-slide-toggle",14),g("change",function(n){return t.showSortable.set(n.checked)}),c(50," Sortable "),m()(),r(51,"div",15),g("cdkDropListDropped",function(n){return t.onMgmtDrop(n)}),h(52,z,1,7,"rui-file-upload-item",16,y),m()()(),v(54,"rui-showcase-code",5),m()),e&2&&(s(8),p("item",t.selectedItem),s(),p("item",t.uploadingItem),s(),p("item",t.doneItem),s(),p("item",t.errorItem),s(),p("html",t.statesHtml)("ts",t.statesTs),s(9),D(t.sortableItems()),s(2),p("html",t.sortableHtml)("ts",t.sortableTs),s(8),p("checked",t.allowExtEdit()),s(),b(" Edit extension (",t.allowExtEdit()?"on":"off \u2014 extension preserved",") "),s(2),D(t.editableItems()),s(2),p("html",t.editableHtml)("ts",t.editableTs),s(9),p("checked",t.showFileMgmt()),s(2),p("checked",t.showEditable()),s(2),p("checked",t.showSortable()),s(2),p("cdkDropListDisabled",!t.showSortable()),s(),D(t.managementItems()),s(2),p("html",t.managementHtml)("ts",t.managementTs))},dependencies:[T,U,E,C,R,V,M,x,k,N,$,S],encapsulation:2})};export{L as FileUploadItemDemo};
